...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/60324bd095aa610015b59f78
...
To start editing your site, you can use the Sanity interface at https://purple-turtle-24bd0.sanity.studio/.
...
Generated at `2021-02-21T12:03:08.735Z` by Stackbit version `0.3.49`.